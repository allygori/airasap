...
export const formSchema = z.object({
  ...
  estimated_shipping_cost: z.number().optional(),
  free_shipping_from_shopee: z.number().optional(),
  shipping_cost_paid_by_buyer: z.number().optional(),
  shipping_cost_discount_by_logistics: z
    .number()
    .optional(),
  shipping_cost_forwarded_by_shopee: z.number().optional(),
  estimated_shipping_cost_discount: z.number().optional(),
