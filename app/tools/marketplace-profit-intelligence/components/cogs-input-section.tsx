      ...
      <AccordionItem value="cogs" className="border-0">
        <AccordionTrigger className="py-4 hover:no-underline">
          <span className="flex items-center gap-2 text-xl font-semibold">
            <DollarSign className="h-5 w-5" /> Input HPP
            (Harga Pokok)
          </span>
        </AccordionTrigger>
          ...
          <div className="space-y-4">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div className="text-muted-foreground text-sm">
                Pilih produk untuk mengisi HPP massal, atau
                ubah HPP per produk langsung di tabel.
              </div>
              <div className="flex flex-wrap items-center gap-2">
                <Input
                  ...
                  value={bulkCOGSValue}
                  onChange={(event) =>
                    onBulkCOGSChange(event.target.value)
                  }
                />
                <Button
                  variant="secondary"
                ...
                <TableBody>
                  ...
                  {products.length === 0 && (
                    <TableRow>
                      ...
                      >
                        Tidak ada data produk ditemukan di
                        laporan ini.
                      </TableCell>
                    </TableRow>
                  )}
